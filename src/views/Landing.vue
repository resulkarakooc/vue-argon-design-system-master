          ...
          <div class="col-lg-12">
            <div class="row">
              <div class="col-md-4 mb-4" v-for="item in items" :key="item.id">
                <div class="card border-0 hover shadow py-5">
                  <div class="card-body text-center">
                    ...
                    <div>
                      <badge type="primary" rounded>{{ item.user.userName }}</badge>
                      
                    </div>
                    <base-button tag="a" :href="`/post/${item.id}`" type="primary" class="mt-4"
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
            <div class="px-4">
              <img
                v-lazy="'https://media.licdn.com/dms/image/D4D03AQHxv9zAo3q_BA/profile-displayphoto-shrink_800_800/0/1714337927390?e=1727308800&v=beta&t=nsePyh2HuZznTctzCs5M1IgZPZEu-grStFZxowf6BJM'"
                class="rounded-circle img-center img-fluid shadow shadow-lg--hover"
                style="width: 200px"
              />
              <div class="pt-4 text-center">
                <h5 class="title">
                  <span class="d-block mb-1">Resul Karakoç</span>
...
export default {
  ...
  mounted() {
    // API'den verileri al
    axios
      .get("http://localhost:8084/api/post")
      .then((response) => {
